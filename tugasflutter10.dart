import 'package:bywulan/Tugas%20Flutter/tugashomeflutter10.dart';
        ...
        child: Column(
          children: [
            ...
            TextFormField(
              ...
              validator: (value) {
                if (value == null || value.isEmpty) {
                  return "Konfirmasi Nomor Handphone tidak boleh kosong";
                } else if (value.length < 8) {
                  return "Konfirmasi No Hp minimal 10 karakter";
                }
                return null;
              },
            ),
            TextFormField(
              ...
              validator: (value) {
                if (value == null || value.isEmpty) {
                  ...
                  return "Kota asal minimal 4 karakter";
                }
                return null;
              },
            ),
                  ...
                  showDialog(
                    ...
                    builder: (context) => AlertDialog(
                      ...
                      content: Column(
                        ...
                        children: [
                          Lottie.asset("assets/animation/boxerlottie.json"),
